...
public class GestionNota extends Gestion<Nota>{
    ...
    public Cursor getCursorNotas(){//Devuelve solo las notas
        return this.getCursor(ContratoBaseDatos.TablaNota.PROJECTION_ALL, ContratoBaseDatos.TablaNota.TIPO, new String[]{Nota.NOTA_SIMPLE + ""}, null, null, ContratoBaseDatos.TablaNota.SORT_ORDER_DEFAULT);
    }

    public Cursor getCursorListas(){//Devuelve solo las listas
        return this.getCursor(ContratoBaseDatos.TablaNota.PROJECTION_ALL, ContratoBaseDatos.TablaNota.TIPO, new String[]{Nota.NOTA_LISTA + ""}, null, null, ContratoBaseDatos.TablaNota.SORT_ORDER_DEFAULT);
    }

    public Cursor getCursorCompletadas(){//Devuelve notas completadas
        return this.getCursor(ContratoBaseDatos.TablaNota.PROJECTION_ALL, ContratoBaseDatos.TablaNota.REALIZADO, new String[]{"1"}, null, null, ContratoBaseDatos.TablaNota.SORT_ORDER_DEFAULT);
    }

    public Cursor getCursorNoCompletadas(){//Devuelve notas no completadas
        return this.getCursor(ContratoBaseDatos.TablaNota.PROJECTION_ALL, ContratoBaseDatos.TablaNota.REALIZADO, new String[]{"0"}, null, null, ContratoBaseDatos.TablaNota.SORT_ORDER_DEFAULT);
    }
